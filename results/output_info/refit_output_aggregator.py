...
for iteration in range(0, num_runs):
    energy_df[iteration] = pd.read_csv("C:/Users/johan/Documents/Uni/Semester 15 und 16/Bachelorarbeit/excess-return-engression/results/output_info/model_run_" + str(iteration+1) + "/output_info.csv").loc[:, "Median Validation ES"]
...
with open("C:/Users/johan/Documents/Uni/Semester 15 und 16/Bachelorarbeit/excess-return-engression/results/output_info/refit_output_aggregation.csv", "w", newline="") as refit_output_aggregation:
    ...
    # Note that a compatible loop implementation in refit guarantees the correct order of models in the csv files to be aggregated
...
tex_df = pd.read_csv("C:/Users/johan/Documents/Uni/Semester 15 und 16/Bachelorarbeit/excess-return-engression/results/output_info/refit_output_aggregation.csv")
tex_str = tex_df.to_latex(index = False)
with open("C:/Users/johan/Documents/Uni/Semester 15 und 16/Bachelorarbeit/excess-return-engression/results/output_info/refit_output_aggregation.tex", "w") as output_tex:
