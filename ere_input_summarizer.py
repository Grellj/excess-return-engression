...
with open("results/input_info/input_shapes.txt", "w") as input_shapes:
    ...
    input_shapes.write("\nThe shape of the ablation version of the X-train-tensor is: \n")
    input_shapes.write(str(ere_dataprep.X_abl_train.shape))
    ...
    input_shapes.write("\nThe shape of the ablation version of the X-validate-tensor is: \n")
    input_shapes.write(str(ere_dataprep.X_abl_validate.shape))
    ...
    input_shapes.write("\nThe shape of the ablation version of the extended X-train-tensor is: \n")
    input_shapes.write(str(ere_dataprep.X_abl_train_extended.shape))
    ...
    input_shapes.write("\nThe shape of the ablation version of the X-test-tensor is: \n")
    input_shapes.write(str(ere_dataprep.X_abl_test.shape))
